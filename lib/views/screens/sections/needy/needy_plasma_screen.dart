...
class NeedyPlasmaScreen extends StatefulWidget {
  @override
  State<NeedyPlasmaScreen> createState() => _NeedyPlasmaScreenState();
}
class _NeedyPlasmaScreenState extends State<NeedyPlasmaScreen> {
  ...
  ElevatedButton.styleFrom(backgroundColor: ColorResources.secondColor);
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Image(
                  image:  Images.plasmaScreenImage,
                  width: 300.0,
                  height: 200.0,
                ),
                Container(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: RadioListTile(
                                      title: Text("Male"),
                                      value: Gender.Male,
                                      activeColor: ColorResources.secondColor,
